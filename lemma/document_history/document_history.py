...
from lemma.document_history.document_history_view import DocumentHistoryView
from lemma.document_history.document_history_presenter import DocumentHistoryPresenter
...
class DocumentHistory(Observable):
    ...
    def __init__(self, workspace):
        ...
        self.view = DocumentHistoryView()
        self.presenter = DocumentHistoryPresenter(self, self.view)
