...
class HeaderBarLeft(Gtk.HeaderBar):
    ...
    def __init__(self):
        ...
        self.app_menu = MenuBuilder.create_menu()

        self.shortcuts_window_button = MenuBuilder.create_button('Keyboard Shortcuts', 'Ctrl+?')
        self.shortcuts_window_button.set_action_name('win.show-shortcuts-dialog')
        MenuBuilder.add_button(self.app_menu, self.shortcuts_window_button)

        self.about_button = MenuBuilder.create_button('About')
        self.about_button.set_action_name('win.show-about-dialog')
        MenuBuilder.add_button(self.app_menu, self.about_button)
