...
class Command():
    ...
    def run(self, document):
        ...
        if y == 0:
            document.ast.move_insert_to_node(document.get_node_at_xy(0, 0))
        else:
            document.ast.move_insert_to_node(document.get_node_at_xy(x, y - document.ast.get_insert_node().box.parent.height * 0.5))
