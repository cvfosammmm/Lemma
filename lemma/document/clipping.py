...
class Clipping(object):
    ...
    def get_current_offsets(self):
        ...
        elif self.last_scroll_animation_type == 'decelerate' and time_since_last_scroll < 3:
