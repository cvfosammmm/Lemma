...
class Dialog(object):
    ...
    def setup(self):
        ...
        self.view.set_website('https://www.cvfosammmm.org/lemma/')
        self.view.set_website_label('https://www.cvfosammmm.org/lemma/')
        self.view.set_authors(('Robert Griesel',))
        self.view.set_logo_icon_name('org.cvfosammmm.Lemma')
