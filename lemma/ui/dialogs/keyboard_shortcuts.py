...
class Dialog():
    ...
    def __init__(self, main_window):
        ...
        section['items'].append({'title': 'Open Pinned Document 1', 'shortcut': '&lt;alt&gt;1'})
        section['items'].append({'title': 'Open Pinned Document 2', 'shortcut': '&lt;alt&gt;2'})
        section['items'].append({'title': 'Open Pinned Document 3', 'shortcut': '&lt;alt&gt;3'})
        section['items'].append({'title': 'Open Pinned Document 4', 'shortcut': '&lt;alt&gt;4'})
        section['items'].append({'title': 'Open Pinned Document 5', 'shortcut': '&lt;alt&gt;5'})
        section['items'].append({'title': 'Open Pinned Document 6', 'shortcut': '&lt;alt&gt;6'})
        section['items'].append({'title': 'Open Pinned Document 7', 'shortcut': '&lt;alt&gt;7'})
        section['items'].append({'title': 'Open Pinned Document 8', 'shortcut': '&lt;alt&gt;8'})
        section['items'].append({'title': 'Open Pinned Document 9', 'shortcut': '&lt;alt&gt;9'})
        data.append(section)
        ...
        section['items'].append({'title': 'Numbered List', 'shortcut': '&lt;ctrl&gt;8'})
        section['items'].append({'title': 'Checklist', 'shortcut': '&lt;ctrl&gt;9'})
