...
class Dialog():
    ...
    def __init__(self, main_window):
        ...
        section['items'].append({'title': 'Open Shortcuts', 'shortcut': '&lt;alt&gt;0'})
        section['items'].append({'title': 'Open Shortcut 1', 'shortcut': '&lt;alt&gt;1'})
        section['items'].append({'title': 'Open Shortcut 2', 'shortcut': '&lt;alt&gt;2'})
        section['items'].append({'title': 'Open Shortcut 3', 'shortcut': '&lt;alt&gt;3'})
        section['items'].append({'title': 'Open Shortcut 4', 'shortcut': '&lt;alt&gt;4'})
        section['items'].append({'title': 'Open Shortcut 5', 'shortcut': '&lt;alt&gt;5'})
        section['items'].append({'title': 'Open Shortcut 6', 'shortcut': '&lt;alt&gt;6'})
        section['items'].append({'title': 'Open Shortcut 7', 'shortcut': '&lt;alt&gt;7'})
        section['items'].append({'title': 'Open Shortcut 8', 'shortcut': '&lt;alt&gt;8'})
        section['items'].append({'title': 'Open Shortcut 9', 'shortcut': '&lt;alt&gt;9'})
        data.append(section)
