...
class Shortcuts():
    ...
    def init():
        ...
        Shortcuts.defaults['paragraph_style_ul'] = '<Control>6'
        Shortcuts.defaults['paragraph_style_ol'] = '<Control>7'
        Shortcuts.defaults['paragraph_style_cl'] = '<Control>8'
        Shortcuts.defaults['paragraph_style_code'] = '<Control>9'
        ...
        Shortcuts.titles['paragraph_style_code'] = 'Code'
