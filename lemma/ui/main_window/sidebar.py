...
class ToolsSidebar(Gtk.ScrolledWindow):
    ...
    def __init__(self):
        ...
        self.symbols = list()
        self.symbols.append({'id': 'punctuation', 'name': 'Punctuation', 'symbols': ['textendash', 'textemdash', 'guillemetleft', 'guillemetright', 'quotedblbase', 'textquotedblleft', 'textquotedblright', 'cdotp', 'colon', 'vdots', 'cdots']})
