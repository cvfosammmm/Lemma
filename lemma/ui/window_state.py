...
class WindowState(object):
    ...
    def update(self):
        ...
        if mode == 'documents' and WorkspaceRepo.get_workspace().get_active_document() != None:
        ...
        sidebar_visible = Settings.get_value('split_navigation_sidebar')
        active_tab = Settings.get_value('navigation_sidebar_active_tab')

        self.update_toggle(self.main_window.backlinks_toggle, sidebar_visible and active_tab == 'backlinks')
        self.update_toggle(self.main_window.graph_panel_toggle, sidebar_visible and active_tab == 'graph_panel')
    ...
    def on_navigation_sidebar_toggle_clicked(self, button, name):
        UseCases.toggle_navigation_sidebar(name)
    ...
    def save_window_state(self):
        ...
        UseCases.settings_set_value('navbar_paned_position', self.main_window.navigation_sidebar_paned.target_position)
